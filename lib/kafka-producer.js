...
Producer.prototype.getProducer = Promise.method(function (opts, topts, customOps) {
  ...
  producer.serializationOptions = customOps.serializationOptions;
  if (customOps.ensureDelivery === true) {
 ...
 * @private
 */
Producer.prototype._serializeType = function (topicName, isKey, data, options) {
  ...
  if (!schema) {
    ...
    return this.serialize(schema, schemaId, data, options);
  }
};
...
Producer.prototype._produceWrapper = function (producerInstance, topicName,
  ...
  var sendKey = this._serializeType(topicName, true, key, producerInstance.serializationOptions);

  var sendValue = value
    ? this._serializeType(topicName, false, value, producerInstance.serializationOptions)
    : null;
 ...
 * @private
 */
Producer.prototype.serialize = function (type, schemaId, value, options) {
  var bufValue = magicByte.toMessageBuffer(value, type, schemaId, options);
