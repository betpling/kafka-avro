...
Consumer.prototype.deserialize = function (type, message) {
  try {
    return magicByte.fromMessageBuffer(type, message.value, this.sr);
  } catch(ex) {
    ...
    return Promise.reject('Failed to deserialize');
  }
};
